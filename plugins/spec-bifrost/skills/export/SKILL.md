...
- 页面级说明：summarize sections, components, tables, cards, steps, tabs, modals, drawers, metricList, timeline, treeList, empty states, and notes by page.
...
- Important tabs, metricList, timeline, treeList, modal, drawer, file, and batch action requirements are preserved when present.
